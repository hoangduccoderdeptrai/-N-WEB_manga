...
<div class="navbar">
    <div class="navbar-container">
        ...
        <div class="nav-item dropdown no-arrow">
            <i><a title="Phim" href="/search" class="fa-solid fa-magnifying-glass"></a></i>
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                @php
                    $avatarUrl = Auth::user()->avartar;
                @endphp
            ...
            <div class="btn-sent" id="chat">
                <div class="btn-send-detail" style="opacity: 0.5;">
                    ...
                    <span class="send" onclick="sendMessage()">
                        ...
                        <button id="send-button" style="opacity: 1;" class="btn-icon send-message-button">
